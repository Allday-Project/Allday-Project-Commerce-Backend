...
public class DummyDataProduct implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        create("ALLDAYPROJECT 1st 팬미팅 [DAY-ONE] 티켓", 88000L, 300, "ALLDAYPROJECT 첫 번째 단독 팬미팅 'DAY-ONE' 오프라인 공연 티켓", ProductStatus.ON_SALE, Category.TICKET, "fan_meeting_ticket.png");
        create("AlldayProject 공식 응원봉", 35000L, 200, "ALLDAYPROJECT 공식 로고 LED 응원봉 (Ver. 1)", ProductStatus.ON_SALE, Category.MERCHANDISE, "official_lightstick.png");
    }
