...
class EventOrderFacadeConcurrencyTest {
    ...
    @Test
    @DisplayName("Redis Lettuce 분산락 - AOP 버전 - Retry 전략 - 성능 및 정합성 테스트")
    ...
    @Test
    @DisplayName("Redis Lettuce 분산락 - AOP 버전 - Blocking 전략 - 성능 및 정합성 테스트")
    ...
    @Test
    @DisplayName("Redisson 분산락 - AOP - Retry - TTL - 성능 및 정합성 테스트")
    void createEventOrder_redisson_aop_retry_ttl() throws Exception {
        // given
        prepareTestData(TEST_TICKET_STOCK);

        // when
        ConcurrencyTestResult result = runConcurrencyTest(
                userId -> eventOrderFacade.createEventOrderWithRedissonLockAopRetry(
                        TEST_TICKET_PRODUCT_ID,
                        userId
                )
        );
        ...
        printResult("Redisson AOP", result, orderCount, product.getStock());
    ...
    @Test
    @DisplayName("Redisson 분산락 - AOP - Blocking - TTL - 성능 및 정합성 테스트")
    void createEventOrder_redisson_aop_blocking_ttl() throws Exception {
        // given
        prepareTestData(TEST_TICKET_STOCK);
    ...
    @Test
    @DisplayName("Redisson 분산락 - AOP - Retry - Watchdog - 성능 및 정합성 테스트")
    void createEventOrder_redisson_aop_retry_watchdog() throws Exception {
        // given
        prepareTestData(TEST_TICKET_STOCK);
        ...
        printResult("Redisson Watchdog AOP", result, orderCount, product.getStock());
    ...
    @Test
    @DisplayName("Redisson 분산락 - AOP - Blocking - Watchdog - 성능 및 정합성 테스트")
    void createEventOrder_redisson_aop_blocking_watchdog() throws Exception {
        // given
        prepareTestData(TEST_TICKET_STOCK);

        // when
        ConcurrencyTestResult result = runConcurrencyTest(
                userId -> eventOrderFacade.createEventOrderWithRedissonLockAopBlockingWatchdog(
                        TEST_TICKET_PRODUCT_ID,
                        userId
                )
        );
